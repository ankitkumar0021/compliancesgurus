    ...
    <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-[#0a95b4] mb-6">
              Welcome to <span className="text-[#0a95b4]">Compliance Gurus</span>
            </h2>
            <div className="prose prose-lg text-gray-600">
              <p className="text-lg mb-6">
                Welcome to <strong className="text-[#0a95b4]">COMPLIANCE GURUS</strong>, your trusted partner in 
              ...
              <p className="text-lg mb-6">
                Founded in 2020, we have established ourselves as industry leaders in telecom regulatory 
                compliance, serving over 50 satisfied clients with 100% compliance success rate.
              </p>
              <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-xl">
                <MdVerified className="text-3xl text-[#0a95b4]" />
                <p className="font-semibold text-[#0a95b4]">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 shadow-xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-[#0a95b4]">Years of Excellence</h3>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100">
                    ...
                    <span className="font-bold text-[#0a95b4]">{item.value}</span>
                  </div>
                ))}
              </div>
            </div>
