        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className={`ml-6 flex-grow ${
                      ...
                      <div className="flex items-center mb-2">
                        <span className={`text-2xl font-bold ${
                          activeYear === milestone.year ? 'text-blue-900' : 'text-gray-600'
                        }`}>
                          {milestone.year}
                        </span>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 text-blue-700 mb-2">
                  <MdTimeline className="mr-2" />
                  <span className="font-semibold">Milestone Details</span>
                </div>
                <h3 className="text-3xl font-bold text-blue-900">{activeMilestone.year}</h3>
              </div>
