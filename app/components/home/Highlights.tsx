    ...
    <section className="section-padding bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-block bg-blue-100 text-[#0a95b4] px-4 py-2 rounded-full mb-4 font-semibold">
            Our Expertise
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {highlights.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#0a95b4] mb-4">{item.title}</h3>
              <p className="text-gray-600 mb-6">{item.description}</p>
              <div className="flex items-center text-[#0a95b4] font-semibold">
        ...
        <div className="mt-16 pt-12 border-t border-gray-200">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-[#0a95b4] mb-4">Trusted by Leading Telecom Companies</h3>
            ...
            {['DoT', 'TRAI', 'TDSAT', 'TCCP', 'ISP', 'VSAT'].map((org) => (
              <div key={org} className="bg-white p-6 rounded-xl shadow-md flex items-center justify-center">
                <div className="text-center">
                  <div className="text-[#0a95b4] font-bold text-xl mb-1">{org}</div>
