      ...
      <div className="relative container mx-auto section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center bg-blue-100 text-[#0a95b4] px-4 py-2 rounded-full mb-6">
              <span className="w-2 h-2 bg-blue-600 rounded-full mr-2 animate-pulse"></span>
              Trusted by 50+ ISPs & Telecom Companies
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0a95b4] mb-6 leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center justify-center lg:justify-start space-x-2">
                  <div className="text-[#0a95b4] text-xl">
                    {feature.icon}
                  </div>
                  <span className="font-semibold text-[#0a95b4]">{feature.text}</span>
                </div>
              ))}
            </div>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-1 hover:rotate-0 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#0a95b4] mb-6">Why Choose Us?</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0a95b4]">Expert Team</h4>
                ...
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  <div className="bg-blue-100 p-3 rounded-full">
                    <span className="text-[#0a95b4] font-bold text-xl">⌛</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-[#0a95b4]">Timely Submissions</h4>
                ...
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0a95b4]">Accuracy Guaranteed</h4>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#0a95b4]">24/7</div>
